namespace Compiler.Expressions.MathOperations
{
    ...
    {
        public DivideOperation(DataType type, MathExpression lhs, MathExpression rhs) : base(Op.Divide, type, lhs, rhs)
        {
        ...
        public static string TryCreate(MathExpression lhs, MathExpression rhs, out MathExpression result)
        {
            ...
            if (lhs.Type == DataType.UInt || rhs.Type == DataType.UInt)
            {
                ...
                result = new DivideOperation(DataType.UInt, lhs, rhs);
                return null;
            }
            else // both are bytes
            {
                result = new DivideOperation(DataType.UByte, lhs, rhs);
                return null;
            }
        }
